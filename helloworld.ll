...
@__const.main.dog = private unnamed_addr constant %struct.D { i32 1, i32 0 }, align 4

; Function Attrs: noinline optnone ssp uwtable(sync)
define void @_Z10print_smthPc(i8* noundef %0) #0 {
  %2 = alloca i8*, align 8
...
define i32 @main() #2 {
  ...
  call void @_Z10print_smthPc(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0))
  %3 = bitcast %struct.D* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %3, i8* align 4 bitcast (%struct.D* @__const.main.dog to i8*), i64 8, i1 false)
  ret i32 0
}
...
attributes #2 = { noinline norecurse optnone ssp uwtable(sync) "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "probe-stack"="__chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.5a,+zcm,+zcz" }
